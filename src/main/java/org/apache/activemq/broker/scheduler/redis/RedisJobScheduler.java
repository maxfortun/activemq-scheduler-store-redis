...
package org.apache.activemq.broker.scheduler.redis;
...
public class RedisJobScheduler implements JobScheduler {
    ...
    @Override
    public void remove(long time, Message messageSend) throws Exception {
        doRemoveRange(time, time);
    }

    @Override
    public void remove(String jobId, Message messageSend) throws Exception {
        doRemoveJob(jobId);
    }

    @Override
    public void removeAllJobs(Message messageSend) throws Exception {
        doRemoveRange(0, Long.MAX_VALUE);
    }

    @Override
    public void removeAllJobs(long start, long finish, Message messageSend) throws Exception {
    ...
    private void doReschedule(RedisJob job, long nextExecutionTime) throws IOException {
	...
	private void doScheduleJob(RedisJob job) throws Exception {
